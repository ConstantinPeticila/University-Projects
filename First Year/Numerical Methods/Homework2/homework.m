function Tema2MN(nume)
        % Functie in care sunt apelate cerintele 1-6 iar rezultatele cerintelor unt scrise in fisierul nume.out
        % Intrari:
        ...
        %%% citire dimensiune vector ce contine valori pentru limita m consideraa la Cerintele 4 si 5
        dim_vector_m = fscanf(fid_in, '%d', 1);
        %%% citire vector cu valori pentru limita m considerata la Cerintele 4 s 5
        ...
        if (fid_aux = fopen('NrValProprii.m', 'r')) ~= -1
                ...
                for i = 1 : dim_vector_lambda
                        ...
                        % afisare valoare lambda curenta si rezultat functie NrVlProprii
        ...
        if (fid_aux = fopen('LimiteValProprii.m', 'r')) ~= -1
                ...
                % afisare limite incadratoare pentru valorile proprii ale matrici tridiagonale simetrice
